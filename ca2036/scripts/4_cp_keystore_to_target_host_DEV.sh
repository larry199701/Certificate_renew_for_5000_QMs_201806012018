...
#      3. cp /backup/mq/install/ca2035/20180222/dbs_DEV/$QMNAME/$qmname.* /var/mqm/qmgrs/$QMNAME/tls/
#      4. ls -l /var/mqm/qmgrs/$QMNAME/tls/
#  Date:                2018_06
#----------------------------------------------------------------------------------------------------------------------------------------
...
if [ -d "/var/mqm/qmgrs/$QMNAME/tls" ] 
then
    echo "Directory /var/mqm/qmgrs/$QMNAME/tls exists." 
    
else
    mkdir /var/mqm/qmgrs/$QMNAME/tls
fi

ls -l /backup/mq/install/ca2035/20180222/dbs_DEV/$QMNAME/$qmname.*
#----------------------------------------------------------------------------------------------------------------------------------------
# 3. cp /backup/mq/install/ca2035/20180222/dbs_DEV/$QMNAME/$qmname.* /var/mqm/qmgrs/$QMNAME/tls/
#----------------------------------------------------------------------------------------------------------------------------------------
cp /backup/mq/install/ca2035/20180222/dbs_DEV/$QMNAME/$qmname.* /var/mqm/qmgrs/$QMNAME/tls/

#----------------------------------------------------------------------------------------------------------------------------------------
# 4. ls -l /var/mqm/qmgrs/$QMNAME/tls/
#----------------------------------------------------------------------------------------------------------------------------------------

ls -l /var/mqm/qmgrs/$QMNAME/tls/*
