...
sub sign_QM_CSRs {
    ...
    my $cmd = "gsk7cmd -cert -sign -file $QM_CSR_File -db $CA_Keystore_name -pw $CA_Keystore_pass -label $CA_Label -target $QM_Cert_File -format ascii -expire $QM_Cert_Expiredate";
