...
#  Usage:               ./4_cp_keystore_to_target_host_Prod.sh <QM_name>
#  Description:         
#      0. check the $QMNAME passed 
#      1. check the target directory: $mqmpath/mqm/qmgrs/$QMNAME
#      2. make dir: $mqmpath/mqm/qmgrs/$QMNAME/tls
#      3. cp /backup/mq/install/ca2035/20180222/dbs_PROD/$QMNAME/$qmname.* $mqmpath/mqm/qmgrs/$QMNAME/tls/
...
ls -l /backup/mq/install/ca2035/20180222/dbs_PROD/$QMNAME/$qmname.*
#----------------------------------------------------------------------------------------------------------------------------------------
# 3. cp /backup/mq/install/ca2035/20180222/dbs_PROD/$QMNAME/$qmname.* $mqmpath/mqm/qmgrs/$QMNAME/tls/
#----------------------------------------------------------------------------------------------------------------------------------------
cp /backup/mq/install/ca2035/20180222/dbs_PROD/$QMNAME/$qmname.* $mqmpath/mqm/qmgrs/$QMNAME/tls/
